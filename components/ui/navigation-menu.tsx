...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn("left-0 top-0 absolute w-auto", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute right-0 top-full flex justify-center w-full")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "relative origin-top-right overflow-hidden",
        "w-full h-[var(--radix-navigation-menu-viewport-height)]",
        "mt-1.5",
        className
      )}
      ref={ref}
